...
**1. Espacio de configuración:** Para este problema, será el espacio generado por todas las matrices cuadradas de dimensión NxN, (9x9 normalmente), si no tenemos en cuenta los números fijos en el problema.
