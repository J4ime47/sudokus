...
**1. Espacio de configuración:** Para este problema, será el espacio generado por todas las matrices cuadradas de dimensión NxN, (9x9 normalmente), si no tenemos en cuenta los números fijos en el problema. Con esto, podemos ver que tenemos $$9^{N \times N}$$ configuraciones distintas, que sería un número del orden de $$10^{77}$$.
